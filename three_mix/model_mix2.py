...
class MIX(nn.Module):
    def __init__(self, f_dim):
        ...
        self.h1_att_conv0 = nn.Conv2d(f_dim, f_dim, kernel_size=3, padding=1)
        self.h1_att_bn0 = nn.BatchNorm2d(f_dim)
        ...
        self.h2_att_conv0 = nn.Conv2d(f_dim, f_dim, kernel_size=3, padding=1)
        self.h2_att_bn0 = nn.BatchNorm2d(f_dim)
        ...
        self.h3_att_conv0 = nn.Conv2d(f_dim, f_dim, kernel_size=3, padding=1)
        self.h3_att_bn0 = nn.BatchNorm2d(f_dim)
        ...
        self.h4_att_conv0 = nn.Conv2d(f_dim, f_dim, kernel_size=3, padding=1)
        self.h4_att_bn0 = nn.BatchNorm2d(f_dim)
        ...
        self.h5_att_conv0 = nn.Conv2d(f_dim, f_dim, kernel_size=3, padding=1)
        self.h5_att_bn0 = nn.BatchNorm2d(f_dim)
        ...
        self.h6_att_conv0 = nn.Conv2d(f_dim, f_dim, kernel_size=3, padding=1)
        self.h6_att_bn0 = nn.BatchNorm2d(f_dim)
    ...
    def forward(self, h1, h2, h3, h4, h5, h6):
        ...
        x = F.relu(self.h1_att_bn0(self.h1_att_conv0(h1)))
        x = F.relu(self.h1_att_bn1(self.h1_att_conv1(x)))   # torch.Size([96, 2048, 3, 9])
        h1_att_x = self.h1_att_bn2(self.h1_att_conv2(x))     # torch.Size([96, 1, 3, 9])

        x = F.relu(self.h2_att_bn0(self.h2_att_conv0(h2)))
        x = F.relu(self.h2_att_bn1(self.h2_att_conv1(x)))  # torch.Size([2, 64, 288, 144])
        h2_att_x = self.h2_att_bn2(self.h2_att_conv2(x))  # torch.Size([2, 1, 288, 144])

        x = F.relu(self.h3_att_bn0(self.h3_att_conv0(h3)))
        x = F.relu(self.h3_att_bn1(self.h3_att_conv1(x)))  # torch.Size([2, 64, 288, 144])
        h3_att_x = self.h3_att_bn2(self.h3_att_conv2(x))

        x = F.relu(self.h4_att_bn0(self.h4_att_conv0(h4)))
        x = F.relu(self.h4_att_bn1(self.h4_att_conv1(x)))  # torch.Size([2, 64, 288, 144])
        h4_att_x = self.h4_att_bn2(self.h4_att_conv2(x))

        x = F.relu(self.h5_att_bn0(self.h5_att_conv0(h5)))
        x = F.relu(self.h5_att_bn1(self.h5_att_conv1(x)))  # torch.Size([2, 64, 288, 144])
        h5_att_x = self.h5_att_bn2(self.h5_att_conv2(x))

        x = F.relu(self.h6_att_bn0(self.h6_att_conv0(h6)))
        x = F.relu(self.h6_att_bn1(self.h6_att_conv1(x)))  # torch.Size([2, 64, 288, 144])
